...
> [!NOTE]
> **Tiered Context Diet Active**: Space knowledge (73.5 KB) exceeds the full-text limit (20.0 KB). Compiled into a high-density Decision Matrix and Executive Abstracts Map to optimize prompt efficiency. To retrieve complete notes on-demand, run `python3 skills/knowledge-vault/scripts/recall_vault.py "<query>"`.
...
| [[decisions/adr_015_webui_routes_deep_domain_decomposition|ADR 015]] | ADR 015: Deep Domain Decomposition of WebUI Routes & Handlers | `Accepted` | **Option 3 was chosen** and executed across Sprints M1 through M7: 1. **Sprint M1 (Approvals & Clarifiers — Commit `81aee10`)**: - Extracted 22 approval and clarifier handlers into `webui/api/route_approvals.py`... |
...
- **[[decisions/adr_015_webui_routes_deep_domain_decomposition|ADR 015: Deep Domain Decomposition of WebUI Routes & Handlers]]** (`Accepted`): **Option 3 was chosen** and executed across Sprints M1 through M7: 1. **Sprint M1 (Approvals & Clarifiers — Commit `81aee10`)**: - Extracted 22 approval and clarifier handlers into `webui/api/route_approvals.py`...
