...
const SHELL_ASSETS = [
  ...
  './static/events.js' + VQ,
  './static/api.js' + VQ,
  './static/ui-theme.js' + VQ,
  './static/i18n.js' + VQ,
  './static/icons.js' + VQ,
  './static/assistant_turn_anchors.js' + VQ,
  './static/ui-notifications.js' + VQ,
  './static/ui-composer.js' + VQ,
  './static/ui-layout.js' + VQ,
  './static/ui.js' + VQ,
  ...
  './static/subagents.js' + VQ,
  './static/mcp_hub.js' + VQ,
  './static/diff_viewer.js' + VQ,
  './static/skills_wizard.js' + VQ,
  './static/slash_palette.js' + VQ,
  './static/vault.js' + VQ,
  './static/analytics.js' + VQ,
  './static/panels.js' + VQ,
  './static/boot.js' + VQ,
    ...
    event.respondWith(
      fetch(new Request(event.request, { cache: 'no-store' })).then((response) => {
        ...
        return caches.match('./').then((cached) => cached || new Response(
          ...
          '<p>Antigravity requires a server connection. Please check your network and try again.</p>' +
          '</body></html>',
