...
const APP_TITLEBAR_KEYS = {
  ...
  subagents: 'tab_subagents', memory: 'tab_memory', workspaces: 'tab_workspaces',
  profiles: 'tab_profiles', todos: 'tab_todos', insights: 'tab_insights', logs: 'tab_logs', settings: 'tab_settings',
};
const MAIN_VIEW_PANELS = ['settings','skills','subagents','memory','tasks','kanban','workspaces','profiles','insights','logs','plugin'];
