...
_callable_accepts_kwarg = _route_session_list_cache._callable_accepts_kwarg
_prune_orphaned_webui_zero_message_sessions = (
    _route_session_list_cache._prune_orphaned_webui_zero_message_sessions
)
_build_session_list_cache_payload = (
    _route_session_list_cache._build_session_list_cache_payload
)
_session_list_payload_to_response = (
    _route_session_list_cache._session_list_payload_to_response
)
_hidden_archived_sidebar_reference_sessions = (
    _route_session_list_cache._hidden_archived_sidebar_reference_sessions
)
_get_cached_session_list_payload = (
    _route_session_list_cache._get_cached_session_list_payload
)
...
from api.route_session_list_cache import (  # noqa: F401 — re-exports for backward compat
    _build_session_list_cache_payload,
